...
def summarytime(pweek,	oldweek,	sumhash,	beta,	outstr,	bph,	forced	=	false)
...
#	raise
	...
	pred.each_with_index{|p,	pi|
		sumhash,	outstr,	oldweek	=	summarytime(p.week,	oldweek,	sumhash,	beta,	outstr,	bph)
		puts
...
#	raise	"bph.inspect #{bph.inspect}"
	sumhash,	outstr,	oldweek	=	summarytime(oldweek+1,	oldweek,	sumhash,	beta,	outstr, bph,	true)
	yt			=	0.0
	yc			=	0
	beta.each{|b|
		begin
